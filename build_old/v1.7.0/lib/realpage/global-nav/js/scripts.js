...
//  Source: _lib\realpage\global-nav\js\providers\global-nav.js
// Global Nav Provider
...
(function (angular) {
    ...
    angular
        .module("rpGlobalNav")
        .provider("rpGlobalNavModel", [GlobalNavModel]);
})(angular);
...
(function (angular) {
    ...
    function rpGlobalNav(model) {
        function link(scope, elem, attr) {
            var navData = model.getData();
            elem.rpGlobalNav(navData);
        }
    ...
    angular
        .module("rpGlobalNav")
        .directive("rpGlobalNav", ["rpGlobalNavModel", rpGlobalNav]);
})(angular);
