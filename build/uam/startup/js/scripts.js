//  Source: uam\lib\startup\js\scripts.js
...
(function (RealPage) {
    ...
    ENV.APPVER = "1bvdeqjos";
    ENV.COMPILETIME = "11/21/2017 01:05:06 am";
...
(function (RealPage) {
    ...
    svc.gen = function () {
        svc.appVer = RealPage.cookie.read('APPVER') || "1bvdeqjos";
...
//  Source: uam\_startup\js\config.js
//  App Startup
...
(function() {
    ...
    RealPage.startup.load({
        ...
        files: [{
            ...
            {
                js: "uam/app/js/scripts.min.js",
                css: "uam/app/css/styles.min.css"
            }
        ]
    });
})();
