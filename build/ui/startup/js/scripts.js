...
(function (RealPage) {
    ...
    ENV.APPVER = "1bnv4q44v";
    ENV.COMPILETIME = "08/20/2017 11:50:49 am";
...
(function (RealPage) {
    ...
    svc.gen = function () {
        svc.appVer = RealPage.cookie.read('APPVER') || "1bnv4q44v";
...
(function () {
    ...
    RealPage.startup.load({
        ...
        files: [
            {
                js: "v1.7.0/lib/app/js/scripts.min.js",
                css: "v1.7.0/lib/app/css/styles.min.css"
            },
            {
