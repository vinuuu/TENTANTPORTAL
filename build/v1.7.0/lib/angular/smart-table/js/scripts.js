//  Source: _lib\__foundation-ui-library\angular\smart-table\js\smart-table.js
/**
* @version 1.4.13
* @license MIT
*/
(function (ng, undefined){
    ...
    ng.module('smart-table', []).run(['$templateCache', function ($templateCache) {
        $templateCache.put('template/smart-table/pagination.html',
            '<div class="pull-left margin-right-24 form-control-label">Displaying {{((stItemsByPage * currentPage) - stItemsByPage) + 1}} - {{stItemsByPage * currentPage}} of {{stItemsByPage * numPages}}</div>' +
            '<nav class="pull-left" ng-if="pages.length >= 2"><ul class="pagination">' +
            '<li><a ng-click="selectPage(1)"><span class="font-12 rp-icon-angle-double-left"></span></a></li>' +
            '<li><a ng-click="selectPage(currentPage - 1)"><span class="font-12 rp-icon-angle-left"></span></a></li>' +
            '<li ng-repeat="page in pages" ng-class="{active: page==currentPage}"><a ng-click="selectPage(page)">{{page}}</a></li>' +
            '<li><a ng-click="selectPage(currentPage + 1)"><span class="font-12 rp-icon-angle-right"></span></a></li>' +
            '<li><a ng-click="selectPage(numPages)"><span class="font-12 rp-icon-angle-double-right"></span></a></li>' +
            '</ul></nav>');
    }]);
