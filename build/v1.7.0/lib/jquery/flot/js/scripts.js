//  Source: _lib\__foundation-ui-library\jquery\flot\js\jquery.flot.js
...
//  Source: _lib\__foundation-ui-library\jquery\flot\js\jquery.flot.resize.js
...
//  Source: _lib\__foundation-ui-library\jquery\flot\js\jquery.flot.pie.js
...
//  Source: _lib\__foundation-ui-library\jquery\flot-tooltip\js\jquery.flot.tooltip.js
/*
 * jquery.flot.tooltip
 *
...
! function(a) {
    ...
    c.prototype.init = function(b) {
        ...
        return 0 === b.length && (b = a("<div />").addClass(this.tooltipOptions.cssClass), b.appendTo("body").hide().css({
            position: "absolute"
        ...
        if ("undefined" != typeof b.series.percent ? f = b.series.percent : "undefined" != typeof b.series.percents && (f = b.series.percents[b.dataIndex]), "number" == typeof f && (a = this.adjustValPrecision(g, a, f)), a = "undefined" != typeof b.series.label ? a.replace(h, b.series.label) : a.replace(h, ""), a = "undefined" != typeof b.series.color ? a.replace(i, b.series.color) : a.replace(i, ""), a = this.hasAxisLabel("xaxis", b) ? a.replace(j, b.series.xaxis.options.axisLabel) : a.replace(j, ""), a = this.hasAxisLabel("yaxis", b) ? a.replace(k, b.series.yaxis.options.axisLabel) : a.replace(k, ""), this.isTimeMode("xaxis", b) && this.isXDateFormat(b) && (a = a.replace(l, this.timestampToDate(c, this.tooltipOptions.xDateFormat, b.series.xaxis.options))), this.isTimeMode("yaxis", b) && this.isYDateFormat(b) && (a = a.replace(m, this.timestampToDate(d, this.tooltipOptions.yDateFormat, b.series.yaxis.options))), "number" == typeof c && (a = this.adjustValPrecision(l, a, c)), "number" == typeof d && (a = this.adjustValPrecision(m, a, d)), "undefined" != typeof b.series.xaxis.ticks) {
            ...
            for (var s in b.series.xaxis[q])
                if (b.series.xaxis[q].hasOwnProperty(r) && !this.isTimeMode("xaxis", b)) {
...
//  Source: _lib\__foundation-ui-library\jquery\flot-spline\js\jquery.flot.spline.js
! function(a) {
    "use strict";
...
//  Source: _lib\__foundation-ui-library\jquery\flot-orderbars\js\jquery.flot.orderbars.js
/*
